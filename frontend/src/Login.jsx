    ...
    return(
        <div className="flex h-screen flex-1 flex-col justify-center items-center px-6 py-12 lg:px-8 bg-gray-800 text-gray-100">
            <div className="flex items-center justify-center">
                ...
                <span className="text-blue-500 font-bold text-4xl inline-block align-bottom ml-4">HotelHUB</span>
            </div>
            ...
            <form className="space-y-6">
                ...
                <div className="flex items-center justify-between">
                    ...
                    {!signup && (<a href="#" className="font-semibold text-blue-600 hover:text-blue-600">Forgot password? </a>)}
                    </div>
                </div>
                <div className="mt-2">
                    <input
            ...
            <p className="mt-10 text-center text-sm text-gray-500">
                ...
                <a onClick={(e)=>setSignup(!signup)} className="font-semibold leading-6 text-blue-600 hover:text-blue-500">
