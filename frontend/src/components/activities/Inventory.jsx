...
export function Input({variable, level}){
    ...
    return(
        ...
        <div className="bg-gray-800 py-4 px-6 pb-8">
            ...
            <input className="block w-full py-2 px-1 rounded-md bg-gray-300 text-black" type={level.includes('Hotel')?'text':'number'} name="" id="" placeholder={level} value={choice} onChange={e=>setChoice(e.target.value)} />
        </div>
        </>
    )
}
